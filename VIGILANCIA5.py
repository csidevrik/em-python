...
def obtener_configuracion():
    ...
    label_fecha_hora = Label(ventana, text="Fecha y hora (YYYY-MM-DD HH:MM):", fg="white", bg="#87CEEB",
                             font=("Arial", 12))
    ...
    boton_carpeta = Button(ventana, text="Seleccionar carpeta", command=seleccionar_carpeta, fg="black", bg="#D3D3D3",
                           font=("Arial", 12))
    ...
    boton_guardar = Button(ventana, text="Guardar", command=guardar_configuracion, fg="black", bg="#D3D3D3",
                           font=("Arial", 12))
...
try:
    ...
    while True:
        ...
        if grabando:
            ...
            cv2.putText(frame2, fecha_hora, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255),
                        1)  # Letras pequeñas y rojas
            out.write(frame2)
